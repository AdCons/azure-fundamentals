'''Python Crash Course 3ed - Chapter 3 - Try It Yourself'''

# 3-1. Names: Store the names of a few of your friends in a list called names.
# Print each person’s name by accessing each element in the list,
# one at a time.
names = ["Adrian", "Alexis", "Cristina", "Diana", "Elena"]
print(names[0])
print(names[1])
print(names[2])
print(names[3])
...
cars = ["Audi", "BMW", "Mercedes", "Porsche", "Volkswagen"]
print(f"I would like to own a {cars[0]} car.")
print(f"A {cars[1]} is superb.")
print(f"I really love {cars[2]} cars.")
print(f"A {cars[3]} is a dream.")
print(f"Owning a {cars[4]} is a pleasure.")
...
#   still in your list.
print(f"{guests[2]} won't be able to make it to dinner.")
print("Instead of him, I would like to invite Connor McGregor.")

guests[2] = "Connor McGregor"

print(f"{guests[2]} will be joining us for dinner.")
...
print("I found a bigger dinner table, so I can invite more people.")
print("I will be inviting Tony Hawk, Elon Musk and Jeff Bezos.")
guests.insert(0, "Tony Hawk")  # Insert at the beginning
guests.insert(len(guests) // 2, "Elon Musk")  # Insert in the middle
guests.append("Jeff Bezos")  # Insert at the end

# 3-7. Shrinking Guest List: You just found out that your new dinner table
# won’t arrive in time for the dinner, and now you have space for only
# two guests.
...
# end of your program.
print("Now, I can only invite two people for dinner.")
gone = guests.pop()
print(f"Sorry {gone}, I can't invite you to dinner.")
gone = guests.pop()
print(f"Sorry {gone}, I can't invite you to dinner.")
gone = guests.pop()
print(f"Sorry {gone}, I can't invite you to dinner.")
