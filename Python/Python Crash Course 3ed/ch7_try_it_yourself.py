'''Python Crash Course 3ed - Chapter 7 - Try It Yourself'''
...
in_data = input("What kind of rental car would you like?: ")
print(f"Let me see if I can find you a {in_data.title()}.")
...
# is ready.
in_data = int(input("How many people are in your dinner group?: "))
if in_data > 8:
    print("I'm sorry, you'll have to wait for a table.")
# 7-3. Multiples of Ten: Ask the user for a number, and then report whether the
# number is a multiple of 10 or not.
in_data = int(input("Is this number a multiple of 10?: "))
if in_data % 10 == 0:
    print(f"{in_data} is a multiple of 10.")
else:
    print(f"{in_data} is not a multiple of 10.")
# 7-4. Pizza Toppings: Write a loop that prompts the user to enter a series
...
while True:
    in_data = input("Enter a pizza topping: ")
    if in_data == "quit":
        print("Goodbye!")
        break
    print(f"Adding {in_data} to your pizza.")
...
while True:
    in_data = int(input("Enter your age: "))
    if in_data == "quit":
        print("Goodbye!")
        break
    if in_data < 3:
